...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed top-0 w-full h-full bg-gray-700/30 first-letter: 
    backdrop-blur-sm flex items-center justify-center font-mono "
      onClick={close}
    >
      <div
        className="w-[65%] h-[75%] bg-gray-950/40 rounded-lg text-white relative"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
          ...
          <div className="flex items-center justify-between w-full h-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2  ">
              <div className="flex items-center w-full">
                ...
                <span className="text-base py-0.5 px-2.5 ml-2 bg-yellow-300/25 text-yellow-300 rounded uppercase">
                  {" "}
                  {coinData.symbol}
                </span>
              </div>
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="text-sm bg-gray-800 text-gray-500 px-1.5 py-0.5 my-1 rounded"
            ...
            <div className="flex flex-col w-[55%] h-full pl-5  ">
              <Chart id={coinData.id} />

              <div className="flex flex-col ">
                <h3 className="text-white py-1">
                  <span className="text-gray-400 capitalize mr-1">
                    market cap rank:{" "}
                  </span>{" "}
