    ...
    <button className="outline-0 border-0 bg-none cursor-pointer"
      ...
      <svg
        className= {`w-[1.5rem]  ml-1.5  
          ${ allCoins.includes(data.id)? "fill-yellow-200" :"fill-gray-400"} hover:fill-yellow-200`}
        width="20"
        height="20"
        viewBox="0 0 30 30"
        fill="yellow"
  ...
  return (
    <>
                    ...
                    <td
                      className={
                        data.price_change_percentage_1h_in_currency > 0
                          ? "text-green-400 py-4 lg:table-cell hidden"
                          : "text-red-400 py-4 lg:table-cell hidden"
                      }
                    >
                      {Number(
      ...
      <div className="flex items-center justify-between mt-4 capitalize h-[2rem]">
        <span>
          Data From
          <a href="https://www.coingecko.com/" className="text-yellow-200" rel="noreferrer" target={"_blank"}>
            {" "}
            CoinGecko{" "}
          </a>
        </span>
