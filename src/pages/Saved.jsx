    ...
    >
      <svg
        className={`w-[1.5rem]  ml-1.5  
          ${
            allCoins.includes(data.id) ? "fill-yellow-200" : "fill-gray-400"
...
export default function Saved() {
  ...
  return (
    <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
      <div className=" w-full min-h-[60vh]    border border-gray-500 rounded">
        {savedData ?
              ...
              <tbody>
                {savedData.map((data) => {
                  return (
                    <tr
                      key={data.id}
                      className="text-center text-base border-b border-gray-500 hover:bg-gray-800 "
                    >
                      <td className="py-4 flex items-cente uppercase">
                        ...
                        />
                        <span>
                          <Link to={`/saved/${data.id}`} className="cursor-pointer">
                            {data.symbol}{" "}
                          </Link>
                        </span>
                      </td>
            ...
            : <h1 className="min-h-[60vh] text-xl text-yellow-200 flex items-center justify-center" > There is no data to display!</h1>
          }
      </div>
